...
with open('converted_products_with_terlaris.json', 'r', encoding='utf-8') as f:
...
print(f"   - All products now have images!")
print(f"   - Images from mcpolo/ and mcpolo-terlaris/")
