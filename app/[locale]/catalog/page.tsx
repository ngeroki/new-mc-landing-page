                ...
                <div className="w-full px-6 md:px-12 lg:px-20 max-w-[1800px] mx-auto py-3 md:py-4">
                    ...
                    <div className="md:hidden space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <select
                                ...
                                className="px-2 py-2 text-xs border border-deep-brown/20 rounded-md focus:outline-none focus:ring-1 focus:ring-warm-sand text-deep-brown bg-white"
                            >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <input
                                ...
                                className="px-2 py-2 text-xs border border-deep-brown/20 rounded-md focus:outline-none focus:ring-1 focus:ring-warm-sand text-deep-brown"
                            />
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex gap-4 items-center">
                        <select
                            value={selectedCategory}
                            onChange={(e) => setSelectedCategory(e.target.value)}
                            className="px-3 py-2 text-base border border-deep-brown/20 rounded-md focus:outline-none focus:ring-2 focus:ring-warm-sand text-deep-brown bg-white"
                        >
                            <option value="all">{t('allCategories')}</option>
                            <option value="men">{t('men')}</option>
                            <option value="women">{t('women')}</option>
                        ...
                        <div className="flex-1 min-w-[200px]">
                            <input
                                ...
                                value={searchQuery}
                                onChange={(e) => setSearchQuery(e.target.value)}
                                className="w-full px-3 py-2 text-base border border-deep-brown/20 rounded-md focus:outline-none focus:ring-2 focus:ring-warm-sand text-deep-brown"
                            />
                        </div>
