...
export default function BestSellersPage() {
    ...
    const displayedProducts = bestsellerProducts.slice(0, displayCount);
    const hasMore = displayCount < bestsellerProducts.length;
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        <div className="inline-block mb-4">
                            <span className="px-4 py-2 bg-warm-sand text-white text-sm font-semibold rounded-full">
                                🔥 {t('bestsellers')}
                            </span>
                        </div>
                        ...
                        <div className="mt-6 text-sm text-deep-brown/60">
                            {bestsellerProducts.length} {t('products')}
                        </div>
                    </motion.div>
                </div>
            </section>
                        ...
                        <>
                            ...
                            {hasMore && (
                                <div className="text-center mt-12">
                                    ...
                                    >
                                        {t('loadMore')} ({bestsellerProducts.length - displayCount} {t('moreProducts')})
                                    </button>
                                </div>
                            )}
                        </>
